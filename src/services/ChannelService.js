...
const ChannelService = {
  ...
  async addChannel(channel) {
    ...
    if (!conversation.managerIds.includes(channel.memberId) && conversation.leaderId.toString() !== channel.memberId)
  ...
  async deleteChannel(channelId, memberId) {
    ...
    if (!conversation.managerIds.includes(memberId) && conversation.leaderId.toString() !== memberId) 
      throw new Error("Member is not access to update channel");
