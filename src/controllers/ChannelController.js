...
const ChannelController = {
    async getAllChannelByConversationId(req, res) {
        ...
        const channels = await ChannelService.getAllChannelByConversationId(conversationId);
        res.json(channels);
    },
    ...
    async updateChannel(req, res) {
        ...
        const channel = req.body;
        const updatedChannel = await ChannelService.updateChannel(channelId, channel);
